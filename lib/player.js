...
function add_hongpai(tingpai) {
    console.log('ai.add_hongpai', tingpai);
    let pai = [];
...
module.exports = class Player extends Majiang.Player {
    qipai(qipai) {
        console.log('ai.Player.qipai', qipai);
        this._defen_cache = {};
        this._eval_cache  = {};
    ...
    action_zimo(zimo, gangzimo) {
        console.log('ai.Player.action_zimo', zimo, gangzimo);
    ...
    action_dapai(dapai) {
        console.log('ai.Player.action_dapai', dapai);
    ...
    action_fulou(fulou) {
        console.log('ai.Player.action_fulou', fulou);
    ...
    action_gang(gang) {
        console.log('ai.Player.action_gang', gang);
    ...
    select_hule(data, hupai, info) {
        console.log('ai.Player.select_hule', data, hupai);
        let rongpai;
        if (data) {
