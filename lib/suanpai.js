...
module.exports = class SuanPai {
    /**
     * 构造函数
     * @param {Object} hongpai 红牌信息
     */
    constructor(hongpai) {
        console.log('ai.SuanPai.constructor', hongpai);
        this._paishu = {
    ...
    /**
     * 起牌时更新牌的信息
     * @param {Object} qipai 起牌信息
     * @param {number} menfeng 门风
     */
    qipai(qipai, menfeng) {
        console.log('ai.Shoupai.qipai', qipai, menfeng);
     ...
     */
    zimo(zimo) {
        console.log('ai.Shoupai.zimo', zimo);
     ...
     */
    dapai(dapai) {
        console.log('ai.Shoupai.dapai', dapai);
     ...
     */
    fulou(fulou) {
        console.log('ai.Shoupai.fulou', fulou);
     ...
     */
    gang(gang) {
        console.log('ai.Shoupai.gang', gang);
    ...
    /**
     * 开杠时更新牌的信息
     * @param {Object} kaigang 开杠信息
     */
    kaigang(kaigang) {
        console.log('ai.Shoupai.kaigang', kaigang);
    ...
    /**
     * 获取所有牌的数量
     * @returns {Object} 所有牌的数量
     */
    paishu_all() {
        console.log('ai.Shoupai.paishu_all');
        let paishu = {};
    ...
    /**
     * 生成牌价值的计算函数
     * @param {Object} shoupai 手牌信息
     * @returns {Function} 计算牌价值的函数
     */
    make_paijia(shoupai) {
        console.log('ai.Shoupai.make_paijia', shoupai);
        let n_suit = {};
        for (let s of ['m','p','s','z']) {
     ...
     * @param {number} l 玩家编号
     * @param {number} c 牌的数量
     * @returns {number} 牌的危险性
     */
    suan_weixian(p, l, c) {
        console.log('ai.Shoupai.suan_weixian', p, l, c);
        let s = p[0], n = +p[1]||5;
    ...
    /**
     * 计算所有牌的危险性
     * @param {Object} bingpai 饼牌信息
     * @returns {Function} 计算危险性的函数
     */
    suan_weixian_all(bingpai) {
        console.log('ai.Shoupai.suan_weixian_all', bingpai);
        let weixian_all;
        for (let l = 0; l < 4; l++) {
